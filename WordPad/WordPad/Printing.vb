...
Public Class RichTextBoxEx
    ...
    Private Sub printDoc_PrintPage(ByVal sender As Object, _
        ...
        m_nFirstCharOnPage = RichTextBoxEx.FormatRange(False, e, m_nFirstCharOnPage, WordPadForm.RichTextBox1.TextLength)

        ' check if there are more pages to print
        If (m_nFirstCharOnPage < WordPadForm.RichTextBox1.TextLength) Then
            e.HasMorePages = True
        Else
